            ...
            return `
              <div class="relative py-1 cursor-pointer shrink-0">
                <button 
                  ...
                  class="hover:text-[#C5A059] font-medium transition-colors ${isActive ? 'font-bold text-[#C5A059] border-b-2 border-[#C5A059] pb-0.5' : 'text-[#1A1A1A]'}"
                >
                  ${nav.name}
                </button>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div class="lg:col-span-5 space-y-5 text-left">
          ...
          <div class="space-y-3 pt-2">
            ...
            <button onclick="addToCart('${p.id}', false); triggerCIELORIACheckout();" class="w-full border-2 border-black bg-white hover:bg-black hover:text-white text-black font-bold py-3.5 rounded-xl text-xs uppercase tracking-widest transition-colors shadow-sm flex items-center justify-center gap-2">
