...
# Ensure initializeCieloriaApp is at the bottom of cieloria_app.js
app_initializer = """
...
if "function safeLaunchApp()" not in js_code:
    js_code = js_code + app_initializer
...
# Ultra-clean HTML with SINGLE script tag loading /app.js
html_template = f"""<!DOCTYPE html>
<!-- SINGLE_SCRIPT_BUILD_{timestamp}_v60000 -->
<html lang="en">
<head>
  <meta charset="UTF-8">
...
print('Successfully deployed single script architecture v60000.0.0!')
